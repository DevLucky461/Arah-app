...
class LoginVerifyOTP extends StatefulWidget {
  ...
  LoginVerifyOTP(this.isExistingUser, this.Mobile, this.OTP, this.body);
  @override
  State<StatefulWidget> createState() => _LoginVerifyOTP();
}

class _LoginVerifyOTP extends State<LoginVerifyOTP> {
  ...
  void initState() {
    ...
    keyboardVisibilityController.onChange.listen((bool visible) {
      if (visible && entered && dataKey.currentContext != null)
  ...
  void next() {
    if (widget.isExistingUser) {
      user = User.map(widget.body['user']);
      CallApi().storeToken(widget.body['token']);
      print(user);
      setState(() {
        click = true;
      });
      ...
      //     context,
      //     MaterialPageRoute(
      //         builder: (BuildContext context) => InputName(widget.Mobile)));
      Navigator.push(context,
          MaterialPageRoute(builder: (BuildContext context) => FinishAccount(widget.Mobile)));
    }
  }
